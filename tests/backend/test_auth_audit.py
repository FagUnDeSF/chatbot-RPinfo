...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("audit-sensitive-email-canonical", "contato joao@example.com"),
        ("audit-sensitive-email-plus", "contato joao.silva+marketing@example.org"),
        ("audit-sensitive-email-subdomain", "contato joao@example.net"),
        ("audit-sensitive-email-tld-uncommon", "contato joao@test.invalid"),
        ("audit-sensitive-email-uppercase", "Contato JOAO@example.com"),
    ],
)
